...
- **Status:** M0 in progress: project scaffold, i18n catalog, pre-commit hooks and CI in place, no features yet. Next steps: the rest of M0 in [docs/roadmap.md](docs/roadmap.md).
